...
- <%= config.bin %> prodly:deploy -n scratchorg --target-org FixesScratchOrg -v MainDevHub
...
- <%= config.bin %> prodly:deploy --target-org test-utxac7gbati9@example.com -v jsmith@acme.com -d "UAT Sandbox Connection"
